...
ace.config = {
    ...
    is: function (b, a) {
        ...
        if (b == 'main-container')
            m = 'container';
        if (b == 'sidebar' && a == 'collapsed')
            m = 'sidebarcollapsed';
        $.ajax({
            type: "Post",
            async: false,
            url: "../Users/GetUserSetting?name=" + m,
    ...
    set: function (b, a) {
        ...
        $.ajax({
            type: "Post",
            url: "../Users/SaveUserSetting?name=" + m + "&value=" + true,
            success: function (data) {
                
            }
        });

        if (document.getElementById('grid-table') != undefined)
    ...
    unset: function (b, a) {
        ...
        $.ajax({
            type: "Post",
            url: "../Users/SaveUserSetting?name=" + m + "&value=" + false,
            success: function (data) {
    ...
    breadcrumbs_fixed: function (a) {
        ...
        if (a) {
            ...
            ace.removeClass(document.body, "breadcrumbs-fixed"); ace.settings.unset("breadcrumbs", "fixed")
        ...
        } var b = document.getElementById("sidebar"); if (a) {
        ...
        a = a || false; var c = document.getElementById("main-container");
        ...
        c = c || false; var e = document.getElementById("sidebar");
