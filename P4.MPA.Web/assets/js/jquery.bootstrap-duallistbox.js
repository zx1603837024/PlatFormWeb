;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
        ...
        infoText: '总记录 {0}',                                                        // text when all options are visible / false for no info text
        infoTextFiltered: '<span class="label label-warning">过滤数据</span>从 {1} 选择  {0}', // when not all of the options are visible due to the filter
