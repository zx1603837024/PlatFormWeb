...
{
    [AbpMvcAuthorize]
    public class VideoPileBusDetailController : P4ControllerBase
    {
        #region Var
        private readonly IVideoEquipBusinessDetailAppService _videoEquipBusinessDetailApplicationService;
        #endregion

        public VideoPileBusDetailController(IVideoEquipBusinessDetailAppService videoEquipBusinessDetailApplicationService)
        {
            _videoEquipBusinessDetailApplicationService = videoEquipBusinessDetailApplicationService;
        }

        // GET: VideoPileBusDetail
        public ActionResult Index()
        {
            return View();
        }

        [AbpMvcAuthorize("VideoPileManagementStopData")]
        ...
        {
            return this.Json(_videoEquipBusinessDetailApplicationService.GetAllVideoPileBusinessDetaillist(input));
        }
        ...
        [AbpMvcAuthorize("VideoPileManagementStopData.Delete")]
        public void VqBusinessDetailDelete(CreateOrUpdateVideoEqBusDetail input)
        {
            ...
            foreach (var item in Ids)
            {
                ...
                _videoEquipBusinessDetailApplicationService.Delete1(temp);
            }
