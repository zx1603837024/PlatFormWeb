...
namespace P4.Businesses
{
    ...
    /// 逃逸明细列表
    /// </summary>
    [Table("AbpEscapeDetail")]
    public class EscapeDetail : FullAuditedEntity<long>, IMustHaveTenant, IMustHaveCompany, IMustHaveRegion, IMustHavePark, IMustHaveBerthsec
    {
